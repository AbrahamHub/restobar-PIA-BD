        ...
        for (var i = 0; i < (sales.length > 3 ? 4 : sales.length); i++) {
            indents.push(
                <tr key={sales[i].id}>
                    ...
                    <td className="h4">
                        {sales[i].delivery ? (
                            <span className={"badge bg-primary"}>Pedidos en marcha</span>
                        ) : (
    ...
    const renderSmallBoxes = () => (
        <>
            ...
            <SmallBox
                ...
                paragraph={"Pedidos para entrega"}
                link={"delivery"}
                color={"danger"}
                icon={"fas fa-truck"}
            />
    ...
    const renderSales = () => (
        <div className="row">
            ...
            <div className="col-12 col-lg-6">
                <div className="card">
                    <div className="card-header border-0">
                        <h3 className="card-title">Descripción general de Restobar</h3>
                    </div>
                        ...
                        <div className="col-12 col-md-3">
                            <div className="card">
                                <div className="card-header">
                                    <h3 className="card-title">
                                    Órdenes de entrega agregadas recientemente
                                    </h3>
                                    <div className="card-tools">
                                        <button
                                            type="button"
                                ...
                                <div className="card-footer text-center">
                                    <Link
                                        ...
                                        className="uppercase"
                                    >
                                        Ver todos los pedidos de entrega
                                    </Link>
                                </div>
                            </div>
                        </div>
