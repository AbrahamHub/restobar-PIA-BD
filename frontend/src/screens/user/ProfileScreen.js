...
const ProfileScreen = ({ history }) => {
    ...
    const handleSubmit = (e) => {
        ...
        if (!name) {
            errorsCheck.name = "Ingresa el nombre.";
        }
        ...
        if (
            ...
            errorsCheck.confirmPassword = "Las contraseñas deben ser las mismas.";
        }
    ...
    const handleModalSubmit = (e) => {
        ...
        if (!passwordCheck.length) {
            errorsCheck.passwordCheck = "Ingresa una contraseña.";
        }
    ...
    const renderModalCheckPassword = () => (
        ...
        >
            ...
            <p>
            Por razones de seguridad, introduzca su contraseña real para
                 confirmar cambios.
            </p>
