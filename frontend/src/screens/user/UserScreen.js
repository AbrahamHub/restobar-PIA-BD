...
const UserScreen = ({ history }) => {
    ...
    const handleSubmit = (e) => {
        ...
        let errorsCheck = {};
        if (!name) {
            errorsCheck.name = "Nombre necesario";
        }
        if (!password) {
            errorsCheck.password = "Contraseña necesaria";
        }

        if (!email) {
            errorsCheck.email = "Email necesario";
        }
        ...
        <table className="table table-hover text-nowrap">
            <thead>
                <tr>
                    ...
                    <th className="d-none d-sm-table-cell">Creado el </th>
                    <th></th>
                </tr>
            </thead>
            <tbody>
